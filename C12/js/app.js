...
function validarNombre(nombre) {
    if (nombre.split(' ').length !== 1) throw "Solo se permite un nombre";
    if (nombre.length > 20) throw "No se permite mas de 20 caracteres"
    if (/\d/.test(nombre)) throw "No se permiten numeros"
    return true;
}
